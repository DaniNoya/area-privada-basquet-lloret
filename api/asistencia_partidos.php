  ...
  switch ($_SERVER['REQUEST_METHOD']) {
      case 'GET':
         ...
         /* $saturday = new Datetime();
          ...
          $dateSaturday = date("Y-m-d",strtotime($end_week."- 1 days"));
          $dateSunday = $end_week;
          ...
          "WHERE e.id_fcbq = p.id_equipo_local AND p.fecha_partido = '$dateSaturday' OR e.id_fcbq = p.id_equipo_local AND p.fecha_partido = '$dateSunday' ".
          "GROUP BY idEquipo;";
