<?php
  ...
  switch ($_SERVER['REQUEST_METHOD']) {
    case 'POST':
        ...
        $sql = "INSERT INTO datos_intermedios(`id`,`data`,`fecha_inscripcion`,`pagoOK`,`pago_Importe`,`presupuesto`,`pagina`,`idTipo_pago`) VALUES (NULL,'$datosPersona',CURRENT_TIMESTAMP(),NULL,'$importeInscripcion','$datosPresupuesto','$paginaReferente',$idTipo_pago);";
