<?php
  ...
  include __DIR__ . "./../LogToFile/LogFile/logFile.php";
              ...
              foreach($value as $persona){
                foreach($persona as $k2 => $value2){
                  if ($k2 == 'nombre') {
                    ...
                    if($importeJugador == $restanteJugador){
                      $quotas[$dniPlayer] = $importeJugador;
                      $importePagado = 0;
                    } else {
                      $importePagado = $importeJugador;
                      $quotas[$dniPlayer] = $importeJugador + $restanteJugador;
                    }
                    ...
                    $log->logMessage("Inscripcion Temporada Mas 18: DNI-> ".$dniPlayer." (Importe Jugador: ".$importeJugador.", Importe Restante: ".$restanteJugador.", Importe Pagado: ".$importePagado.", Quota: ".$quotas[$dniPlayer].")");
              ...
              if ($resultPersona = mysqli_query($con, $sqlConsultaIdPersona)) {
                  ...
                  if ($result = mysqli_query($con, $sqlConsultaJugador)) {
                      if ($result->num_rows > 0) {
                          ...
                          $sqlInsertJugador = "INSERT INTO jugador (id, baja, tarjetaSanitaria) VALUES ('$idPersonaMas18',0,'$tsiPlayer')";
                    ...
                    for ($i=0; $i < count($arrayJugadoresPresupuesto); $i++) {
                      ...
                      if ($value2 == $name) {
                        ...
                        if($importeJugador == $restanteJugador){
                          ...
                          $quotas[$dniJugador] = $importeJugador + $restanteJugador;
                          $importePagado = $importeJugador;
                        }

                        $log->logMessage("Inscripcion Temporada Menos 18: DNI-> ".$dniJugador." (Importe Jugador: ".$importeJugador.", Importe Restante: ".$restanteJugador.", Importe Pagado: ".$importePagado.", Quota: ".$quotas[$dniJugador].")");
