          ...
          if ($k == 'Jugadores') {
            foreach($value as $jugador){
              ...
              foreach($jugador as $k2 => $value2){
                ...
                if ($k2 == 'form_fields[camisetaCampusBullsJugador]') {$arrayJugador['TallaCamisetaCampusBulls'] = $value2;}
              }
          ...
          if(strpos($response->resultat, "KO") === false){
            foreach($arrayJugadores as $k => $value){
              foreach($value as $k2 => $value2){
                ...
                if($k2 == 'TallaCamisetaCampusBulls') {$tallaCamisetaCampusBullsJ = $value2;}
              }
              ...
              if(strpos($response->resultat, "KO") === false){
                  ...
                  if ($resultPersona = mysqli_query($con, $sqlConsultaIdPersona)) {
                      ...
                      if ($result = mysqli_query($con, $sqlConsultaJugador)) {
                          if ($result->num_rows > 0) {
                              $sqlUpdateRelacionJugador = "UPDATE jugador SET baja = 0, tarjetaSanitaria = '$tsiJ', escuela = '$schoolJ', curso = '$courseJ', talla_camiseta_campus_bulls = '$tallaCamisetaCampusBullsJ' WHERE id = '$idPersonaMenos18'";
                              ...
                              $sqlInsertRelacionJugador = "INSERT INTO jugador (id, baja, tarjetaSanitaria, escuela, curso, talla_camiseta_campus_bulls) VALUES ('$idPersonaMenos18',0,'$tsiJ','$schoolJ','$courseJ','$tallaCamisetaCampusBullsJ')";
