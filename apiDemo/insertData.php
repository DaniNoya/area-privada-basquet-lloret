            ...
            foreach($arrayJugadores as $k => $value){
              ...
              if(strpos($response->resultat, "KO") === false){
                  ...
                  if ($resultPersona = mysqli_query($con, $sqlConsultaIdPersona)) {
                      ...
                      if ($result = mysqli_query($con, $sqlConsultaJugador)) {
                          if ($result->num_rows > 0) {
                              $sqlUpdateRelacionJugador = "UPDATE jugador SET baja = 0, tarjetaSanitaria = '$tsiJ', escuela = '$schoolJ', curso = '$courseJ', numero_dorsal = '$numeroDorsalJ', talla_ropa_juego = '$talla1RopaJ', nombre_dorsal = '$nomDorsalJ', talla_camiseta_tecnica_escoleta = '$tallaCamisetaTecnicaEscoletaJ' WHERE id = '$idPersonaMenos18'";
                              ...
                              $sqlInsertRelacionJugador = "INSERT INTO jugador (id, baja, tarjetaSanitaria, escuela, curso, numero_dorsal, talla_ropa_juego, nombre_dorsal, talla_camiseta_tecnica_escoleta) VALUES ('$idPersonaMenos18',0,'$tsiJ','$schoolJ','$courseJ','$numeroDorsalJ','$talla1RopaJ','$nomDorsalJ','$tallaCamisetaTecnicaEscoletaJ')";
