<?php
    ...
    if($result = mysqli_query($con, $sqlConsultDatosIntermedios)){
        if ($result->num_rows > 0) {
            ...
            $transType = "0";
            $terminal = "001";
            $urlResponse = "https://areaprivada.basquetlloret.com/receptorServerTestCampusInvierno.php"; //URL dónde el servidor espera la respuesta del pago
            $urlCliente = "https://areaprivada.basquetlloret.com/receptorClienteTest.php?id=".$idTransaccion; //URL dónde el cliente será redirigido para ver el resumen del pago (OK/KO)
            $pruebas = true;
