<?php
 ...
 function emailConf($name, $firstSurname, $secondSurname, $email, $dni){
    ...
    if (mysqli_query($con, $sqlUpdateUsuario)) {
      ...
      $mail->Body = str_replace('{url}', 'https://areaprivada.basquetlloret.com/confirmMailDemo.php?id='.$enlaceConfirm, $mail->Body);
